...
func (x *AutocompleteRequest) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
func (x *AutocompleteRequest) GetFocusPoint() *geo.Coordinate {
	if x != nil {
		return x.FocusPoint
	}
	return nil
...
func (x *AutocompleteRequest) GetSize() int32 {
	if x != nil && x.Size != nil {
		return *x.Size
	}
	return 0
...
func (x *AutocompleteResponse) GetResults() []*Result {
	if x != nil {
		return x.Results
	}
	return nil
...
const file_search_v1_search_proto_rawDesc = "" +
	...
	"\x04name\x18\x0e \x01(\tR\x04name2\xe3\x02\n" +
	"\rSearchService\x12_\n" +
	...
	"\x0eReverseGeocode\x12 .search.v1.ReverseGeocodeRequest\x1a!.search.v1.ReverseGeocodeResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/api/v1/search/reverse\x12w\n" +
	"\fAutocomplete\x12\x1e.search.v1.AutocompleteRequest\x1a\x1f.search.v1.AutocompleteResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/api/v1/search/autocompleteB0Z.github.com/swayrider/protos/search/v1;searchv1b\x06proto3"
...
var file_search_v1_search_proto_goTypes = []any{
	...
	(*AutocompleteRequest)(nil),    // 4: search.v1.AutocompleteRequest
	(*AutocompleteResponse)(nil),   // 5: search.v1.AutocompleteResponse
	(*Result)(nil),                 // 6: search.v1.Result
	(*geo.BoundingBox)(nil),        // 7: common_types.BoundingBox
	(*geo.Coordinate)(nil),         // 8: common_types.Coordinate
}
var file_search_v1_search_proto_depIdxs = []int32{
	7,  // 0: search.v1.SearchRequest.viewport:type_name -> common_types.BoundingBox
	8,  // 1: search.v1.SearchRequest.focus_point:type_name -> common_types.Coordinate
	6,  // 2: search.v1.SearchResponse.results:type_name -> search.v1.Result
	8,  // 3: search.v1.ReverseGeocodeRequest.point:type_name -> common_types.Coordinate
	6,  // 4: search.v1.ReverseGeocodeResponse.results:type_name -> search.v1.Result
	8,  // 5: search.v1.AutocompleteRequest.focus_point:type_name -> common_types.Coordinate
	6,  // 6: search.v1.AutocompleteResponse.results:type_name -> search.v1.Result
	0,  // 7: search.v1.SearchService.Search:input_type -> search.v1.SearchRequest
	2,  // 8: search.v1.SearchService.ReverseGeocode:input_type -> search.v1.ReverseGeocodeRequest
	4,  // 9: search.v1.SearchService.Autocomplete:input_type -> search.v1.AutocompleteRequest
	1,  // 10: search.v1.SearchService.Search:output_type -> search.v1.SearchResponse
	3,  // 11: search.v1.SearchService.ReverseGeocode:output_type -> search.v1.ReverseGeocodeResponse
	5,  // 12: search.v1.SearchService.Autocomplete:output_type -> search.v1.AutocompleteResponse
